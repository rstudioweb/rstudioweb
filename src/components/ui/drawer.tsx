  ...
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          "tw-group/drawer-content tw-bg-white tw-fixed tw-z-50 tw-flex tw-h-auto tw-flex-col dark:tw-bg-neutral-950",
        ...
        {...props}
      >
        <div className="tw-bg-neutral-100 tw-mx-auto tw-mt-4 tw-hidden tw-h-2 tw-w-[100px] tw-shrink-0 tw-rounded-full tw-group-data-[vaul-drawer-direction=bottom]/drawer-content:block dark:tw-bg-neutral-800" />
        {children}
      </DrawerPrimitive.Content>
    </DrawerPortal>
  )
