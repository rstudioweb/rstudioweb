...
const questions = [
  ...
  {
    id: "experience",
    label: "📹 Any streaming experience?",
    type: "text",
    required: false,
  },
  {
  ...
  {
    id: "aadhaar",
    label: "🆔 Do you have Aadhaar card?",
    type: "text",
    required: true,
  },
...
export default function ChatbotForm() {
  ...
  const handleInput = (e: any) => {
    const value =
      currentQuestion.type === "file" ? e.target.files[0] : e.target.value;
    ...
    if (selfieFile) {
      try {
        ...
        const uploadRes = await fetch(
          "https://script.google.com/macros/s/AKfycby4xZ0UUXENGBy18dWNnkBhCdeKIgM6OC5Ew58f9K6W0dYw3n1gyiZ2LTEx0JX6GgRO/exec",
          {
            method: "POST",
            body: imageFormData,
            headers: {
      ...
      <div className="w-full max-w-xl space-y-4">
        <div className="text-center">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">
            Answer the questions like a chat
          </p>
        </div>
